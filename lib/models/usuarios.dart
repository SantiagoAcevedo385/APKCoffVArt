...
DataModelUsuario dataModelFromJson(String str) =>
    DataModelUsuario.fromJson(json.decode(str));

String dataModelToJson(DataModelUsuario data) => json.encode(data.toJson());

class DataModelUsuario {
  DataModelUsuario({required this.usuarios});

  List<Usuario> usuarios;

  factory DataModelUsuario.fromJson(Map<String, dynamic> json) =>
      DataModelUsuario(
